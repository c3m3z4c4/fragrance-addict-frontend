  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        googleEmailNote: 'Email is managed by Google and cannot be changed here.',
        ...
        pwFailed: 'Failed to update password',
        pwTooShort: 'Password must be at least 8 characters',
        pwMismatch: 'Passwords do not match',
        googlePwNote: 'Password is managed by Google. You can set a local password via the admin panel.',
      },
      // Activity Monitor
      activity: {
  ...
  es: {
    translation: {
      ...
      performance: {
        title: 'Rendimiento',
        sillage: 'Estela',
        sillageTitle: 'Estela de la Fragancia',
        ...
        veryweak: 'Muy Débil',
        eternal: 'Eterna',
        longlasting: 'Duradera',
        verylong: 'Muy Duradera',
      },
      // When To Use
      whenToUse: {
        title: 'Cuándo Usarlo',
      ...
      profile: {
        ...
        emailSaved: 'Email actualizado',
        emailFailed: 'Error al actualizar el email',
        googleEmailNote: 'El email es gestionado por Google y no puede cambiarse aquí.',
        changePassword: 'Cambiar Contraseña',
        currentPassword: 'Contraseña actual',
        newPassword: 'Nueva contraseña',
        confirmPassword: 'Confirmar nueva contraseña',
        savePw: 'Guardar contraseña',
        pwSaved: 'Contraseña actualizada',
        pwFailed: 'Error al actualizar la contraseña',
        pwTooShort: 'La contraseña debe tener al menos 8 caracteres',
        pwMismatch: 'Las contraseñas no coinciden',
        googlePwNote: 'La contraseña es gestionada por Google.',
      },
      // Activity Monitor
      activity: {
